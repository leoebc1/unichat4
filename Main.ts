                    ...
                    while(loopProcurarPosts){
                        ...
                        if((opcaoProcurarPost !== '00') && contaPuxada){
                            ...
                            while (menuPosts){
                                ...
                                if(opcaoMenuPosts <= contaPuxada.getPosts().length){
                                    ...
                                    switch (opcaoInteracaoPost){
                                        case 1:
                                            console.clear()
                                            contaPuxada.getPosts()[opcaoInteracaoPost - 1].curtir(contaLogada)
                                        ...
                                        case 2:
                                            ...
                                            contaPuxada.getPosts()[opcaoMenuPosts - 1].comentar(contaLogada, comentario)
